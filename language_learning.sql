...
(1, 'mark', 'mike@gmail.com', '$2y$10$fJqNbczJ0SuvbRIVZEPIBeHyioYQf0RawSkSjyeLGzIiex/fLSFhC', '2024-07-03 19:21:37'),
(2, 'Terrence', '123@gmail.com', '$2y$10$7An8CfZ8FT3.QbPFyq6mD.eYs5PSlC0cwplqWh6MAid6F/g8rzJAC', '2024-07-04 15:03:06'),
(3, 'Dan', '11@gmail.com', '$2y$10$hoCgyqACsVzIIGkmUM8kXu0aKPB3Pk0TkuFcjt6ss9AT10gZLYY5.', '2024-07-04 15:08:16');
...
ALTER TABLE `challenges`
  ...
  ADD CONSTRAINT `challenges_ibfk_2` FOREIGN KEY (`opponent_id`) REFERENCES `users` (`id`);
